...
{
	private readonly object _cacheAgentLock = new object();
	...
	public IComponentAgent GetAgent(Type refAssemblyType = null)
	{
		lock (_cacheAgentLock)
		{
			...
			return _cacheAgent = HotfixManager.GetAgent<IComponentAgent>(this, refAssemblyType);
		}
	}
	...
	{
		IComponentAgent agent = GetAgent();
		if (agent != null)
		{
