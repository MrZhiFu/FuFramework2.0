...
using FuFramework.DataBase.Storage;
...
/// 缓存数据对象
/// </summary>
public abstract class BaseCacheState : ICacheState, ISafeDelete, ISafeCreate, ISafeUpdate, IEntity
{
	...
	{
		CheckStateHash();
		(bool, byte[]) tuple = _stateHash.IsChanged();
		return (isChanged: tuple.Item1, stateId: Id, data: tuple.Item2);
	}
