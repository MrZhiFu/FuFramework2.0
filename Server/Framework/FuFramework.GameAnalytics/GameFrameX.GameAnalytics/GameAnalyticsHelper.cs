...
namespace FuFramework.GameAnalytics;
...
public static class GameAnalyticsHelper
{
	...
	{
		ArgumentNullException.ThrowIfNull(gameKey, "gameKey");
		ArgumentNullException.ThrowIfNull(gameSecret, "gameSecret");
	...
	public static void SetGlobalCustomEventFields(Dictionary<string, object> customFields)
	{
		if (_isInit)
		{
			ArgumentNullException.ThrowIfNull(customFields, "customFields");
	...
	public static void Event(string eventId, Dictionary<string, object> customFields = null)
	{
		if (_isInit)
		{
			ArgumentNullException.ThrowIfNull(eventId, "eventId");
	...
	public static void Progression(ProgressionStatus progressionStatus, string progression01, string progression02, string progression03, double score, IDictionary<string, object> customFields = null, bool mergeFields = false)
	{
		if (_isInit)
		{
			EGAProgressionStatus progressionStatus2 = EGAProgressionStatus.Undefined;
			switch (progressionStatus)
			{
			case ProgressionStatus.Start:
				progressionStatus2 = EGAProgressionStatus.Start;
				break;
			case ProgressionStatus.Complete:
				progressionStatus2 = EGAProgressionStatus.Complete;
				break;
			case ProgressionStatus.Fail:
				progressionStatus2 = EGAProgressionStatus.Fail;
				break;
			}
			GameAnalyticsSDK.Net.GameAnalytics.AddProgressionEvent(progressionStatus2, progression01, progression02, progression03, score, customFields, mergeFields);
		}
	}
