...
public class DefaultNetWorkChannel : BaseNetWorkChannel
{
	...
	public DefaultNetWorkChannel(IGameAppSession session, AppSetting setting, IRpcSession rpcSession = null, bool isWebSocket = false)
		: base(session, setting, rpcSession, isWebSocket)
	{
	}
}
