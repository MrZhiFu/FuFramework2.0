...
public class ReadWriteDelegateStream : Stream
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="T:FuFramework.SuperSocket.Connection.ReadWriteDelegateStream" /> class with the specified base, read, and write streams.
	/// </summary>
