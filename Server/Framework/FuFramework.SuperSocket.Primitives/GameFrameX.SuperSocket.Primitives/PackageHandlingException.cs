...
public class PackageHandlingException<TPackageInfo> : Exception
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="T:FuFramework.SuperSocket.Primitives.PackageHandlingException`1" /> class with the specified message, package, and inner exception.
	/// </summary>
