...
public abstract class BeginEndMarkPipelineFilter<TPackageInfo> : PipelineFilterBase<TPackageInfo> where TPackageInfo : class
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="T:FuFramework.SuperSocket.ProtoBase.BeginEndMarkPipelineFilter`1" /> class.
	/// </summary>
	...
	public override TPackageInfo Filter(ref SequenceReader<byte> reader)
	{
		...
		if (!reader.TryReadTo(out ReadOnlySequence<byte> sequence, span2, advancePastDelimiter: false))
		{
			return null;
		}
