...
public class DelegatePipelineFilterFactory<TPackageInfo> : PipelineFilterFactoryBase<TPackageInfo>
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="T:FuFramework.SuperSocket.ProtoBase.DelegatePipelineFilterFactory`1" /> class with the specified service provider and factory delegate.
	/// </summary>
