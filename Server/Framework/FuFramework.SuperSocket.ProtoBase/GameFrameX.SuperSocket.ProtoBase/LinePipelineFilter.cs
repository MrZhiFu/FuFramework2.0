...
public class LinePipelineFilter : TerminatorPipelineFilter<TextPackageInfo>
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="T:FuFramework.SuperSocket.ProtoBase.LinePipelineFilter" /> class with UTF-8 encoding.
	/// </summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="T:FuFramework.SuperSocket.ProtoBase.LinePipelineFilter" /> class with the specified encoding.
	/// </summary>
	...
	/// <returns>The decoded <see cref="T:FuFramework.SuperSocket.ProtoBase.TextPackageInfo" />.</returns>
