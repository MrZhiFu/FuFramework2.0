...
public class GZipStreamInitializer : IConnectionStreamInitializer
{
	...
	{
		return Task.FromResult((Stream)new ReadWriteDelegateStream(stream, new GZipStream(stream, CompressionMode.Decompress), new GZipStream(stream, CompressionLevel)));
	}
