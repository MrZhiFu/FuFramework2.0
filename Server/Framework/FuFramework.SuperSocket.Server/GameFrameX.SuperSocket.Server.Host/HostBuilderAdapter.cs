...
public abstract class HostBuilderAdapter<THostBuilder> : IHostBuilder where THostBuilder : HostBuilderAdapter<THostBuilder>
{
	/// <summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="T:FuFramework.SuperSocket.Server.Host.HostBuilderAdapter`1" /> class with default settings.
	/// </summary>
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="T:FuFramework.SuperSocket.Server.Host.HostBuilderAdapter`1" /> class with the specified arguments.
	/// </summary>
	/// <param name="args">The command-line arguments for the host builder.</param>
	public HostBuilderAdapter(string[] args)
		: this(Microsoft.Extensions.Hosting.Host.CreateDefaultBuilder(args))
	{
	}

	/// <summary>
	/// Initializes a new instance of the <see cref="T:FuFramework.SuperSocket.Server.Host.HostBuilderAdapter`1" /> class with the specified host builder.
	/// </summary>
