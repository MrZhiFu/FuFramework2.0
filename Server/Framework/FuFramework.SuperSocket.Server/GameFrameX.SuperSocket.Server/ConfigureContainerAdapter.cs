...
/// <summary>
/// Provides an implementation of <see cref="T:FuFramework.SuperSocket.Server.IConfigureContainerAdapter" /> for a specific container builder type.
/// </summary>
...
internal class ConfigureContainerAdapter<TContainerBuilder> : IConfigureContainerAdapter
{
	...
	/// <summary>
	/// Initializes a new instance of the <see cref="T:FuFramework.SuperSocket.Server.ConfigureContainerAdapter`1" /> class with the specified action.
	/// </summary>
