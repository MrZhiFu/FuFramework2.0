...
public class WebSocketConstant
{
	...
	public const string ResponseExtensionsLinePrefix = "Sec-WebSocket-Extensions:";
	...
	public const string ResponseProtocolLine = "Sec-WebSocket-Protocol: {0}\r\n";
	...
	public static byte[] ClosingHandshake = new byte[2] { 255, 0 };
