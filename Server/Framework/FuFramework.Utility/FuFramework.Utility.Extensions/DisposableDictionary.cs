...
public class DisposableDictionary<TKey, TValue> : NullableDictionary<TKey, TValue>, IDisposable where TValue : IDisposable
{
	...
	/// <summary>
	/// 初始化一个新的 <see cref="T:FuFramework.Utility.Extensions.DisposableDictionary`2" /> 实例。
	/// </summary>
	...
	/// <summary>
	/// 使用指定的默认值初始化一个新的 <see cref="T:FuFramework.Utility.Extensions.DisposableDictionary`2" /> 实例。
	/// </summary>
	...
	/// <summary>
	/// 使用指定的初始容量初始化一个新的 <see cref="T:FuFramework.Utility.Extensions.DisposableDictionary`2" /> 实例。
	/// </summary>
	...
	/// <summary>
	/// 使用指定的字典初始化一个新的 <see cref="T:FuFramework.Utility.Extensions.DisposableDictionary`2" /> 实例。
	/// </summary>
	/// <param name="dictionary">用于初始化的字典。</param>
	public DisposableDictionary(IDictionary<NullObject<TKey>, TValue> dictionary)
		: base(dictionary)
	{
	}
