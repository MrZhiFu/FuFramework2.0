...
public class LookupX<TKey, TElement> : IEnumerable<List<TElement>>, IEnumerable
{
	...
	/// <summary>
	/// 使用指定的字典初始化一个新的 <see cref="T:FuFramework.Utility.Extensions.LookupX`2" /> 实例。
	/// </summary>
	...
	/// <summary>
	/// 使用指定的并发字典初始化一个新的 <see cref="T:FuFramework.Utility.Extensions.LookupX`2" /> 实例。
	/// </summary>
