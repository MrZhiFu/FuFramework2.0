...
public class NullableDictionary<TKey, TValue> : Dictionary<NullObject<TKey>, TValue>
{
	...
	public TValue this[TKey key]
	{
		get
		{
			if (!TryGetValue(new NullObject<TKey>(key), out var value))
			{
				return FallbackValue;
			}
			return value;
	...
	/// <param name="dictionary">用于初始化字典的键值对集合</param>
	/// <param name="comparer">用于键的比较器</param>
	public NullableDictionary(IDictionary<NullObject<TKey>, TValue> dictionary, IEqualityComparer<NullObject<TKey>> comparer)
