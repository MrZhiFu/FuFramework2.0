...
public static class ObjectExtension
{
	...
	/// <exception cref="T:System.ArgumentNullException">当参数为null,引发参数为空异常</exception>
	...
	/// <exception cref="T:System.ArgumentOutOfRangeException">当参数不在范围内时,引发参数为空异常</exception>
	...
	/// <param name="maxValue">最大值</param>
	/// <returns>返回是否在范围内</returns>
	public static bool IsRange(this uint value, uint minValue = 0u, uint maxValue = uint.MaxValue)
	{
		if (value <= minValue || value >= maxValue)
		{
			return false;
	...
	/// <param name="maxValue">最大值</param>
	/// <returns>返回是否在范围内</returns>
	public static bool IsRange(this long value, long minValue = 0L, long maxValue = long.MaxValue)
	{
		if (value <= minValue || value >= maxValue)
		{
			return false;
	...
	/// <param name="maxValue">最大值</param>
	/// <returns>返回是否在范围内</returns>
	public static bool IsRange(this ulong value, ulong minValue = 0uL, ulong maxValue = ulong.MaxValue)
	{
		if (value <= minValue || value >= maxValue)
		{
			return false;
