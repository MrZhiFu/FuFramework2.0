...
namespace FuFramework.CodeGenerator.Utils;
...
public static class ResLoader
{
    public static string LoadTemplate(string resourceName)
    {
        ...
        resourceName = $"FuFramework.CodeGenerator.Template.{resourceName}";
    ...
    public static void LoadDll()
    {
        AppDomain.CurrentDomain.AssemblyResolve += (_, args) =>
        {
            ...
            var resourceName = $"FuFramework.CodeGenerator.{name.Name}.dll";
