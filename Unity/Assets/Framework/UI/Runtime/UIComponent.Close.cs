namespace GameFrameX.UI.Runtime
{
    public partial class UIComponent
    {
        ...
        public void CloseUIForm<T>(object userData = null) where T : IUIForm => m_UIManager.CloseUIForm<T>(userData);
        ...
        /// </summary>
        /// <param name="serialId">要关闭界面的序列编号。</param>
        public void CloseUIFormNow(int serialId) => m_UIManager.CloseUIFormNow(serialId);
        ...
        /// <param name="serialId">要关闭界面的序列编号。</param>
        /// <param name="userData">用户自定义数据。</param>
        public void CloseUIFormNow(int serialId, object userData) => m_UIManager.CloseUIFormNow(serialId, userData);

        /// <summary>
        /// 立即关闭界面。
        /// </summary>
        /// <param name="uiForm">要关闭的界面。</param>
        public void CloseUIFormNow(IUIForm uiForm) => m_UIManager.CloseUIFormNow(uiForm);
        ...
        /// </summary>
        /// <typeparam name="T">关闭界面的类型</typeparam>
        public void CloseUIFormNow<T>(object userData = null) where T : IUIForm => m_UIManager.CloseUIFormNow<T>(userData);
        ...
        /// <param name="uiForm">要关闭的界面。</param>
        /// <param name="userData">用户自定义数据。</param>
        public void CloseUIFormNow(IUIForm uiForm, object userData) => m_UIManager.CloseUIFormNow(uiForm, userData);
