...
//     /// 基础组件。
//     /// </summary>
//     public sealed class BaseModule : FuModule
//     {
//         protected internal override int Priority => ModulePriority.System;
//         
//
//         /// 游戏暂停之前的速度
...
//             InitJsonHelper();
//
//             FuLog.Info("游戏版本号: {0}, Unity版本号: {1}", Version.GameVersion, Application.unityVersion);
//
...
//             {
//                 FuLog.Error("找不到文本辅助器类型'{0}'.", m_TextHelperTypeName);
//                 return;
//             }
//
...
//             if (textHelper == null)
//             {
//                 FuLog.Error("创建文本辅助器实例'{0}'失败.", m_TextHelperTypeName);
//                 return;
//             }
//
...
//             {
//                 FuLog.Error("不能找到压缩辅助器类型'{0}'.", m_CompressionHelperTypeName);
//                 return;
//             }
//
...
//             {
//                 FuLog.Error("创建压缩辅助器实例'{0}'失败.", m_CompressionHelperTypeName);
//                 return;
//             }
//
...
//             {
//                 FuLog.Error("不能找到Json辅助器类型'{0}'.", m_JsonHelperTypeName);
//                 return;
//             }
//
...
//             if (jsonHelper == null)
//             {
//                 FuLog.Error("创建Json辅助器实例'{0}'失败.", m_JsonHelperTypeName);
//                 return;
//             }
//
