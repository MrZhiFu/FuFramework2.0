...
namespace FuFramework.Core.Runtime
{
    ...
    /// </summary>
    [Serializable]
    public class GameFrameworkException : System.Exception
    {
        /// <summary>
        /// 初始化游戏框架异常类的新实例。
        /// </summary>
        ...
        public GameFrameworkException(string message, System.Exception innerException) : base(message, innerException) { }
