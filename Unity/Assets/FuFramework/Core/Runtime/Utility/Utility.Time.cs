...
namespace FuFramework.Core.Runtime
{
    public static partial class Utility
    {
        ...
        public static class Time
        {
            ...
            /// <summary>
            /// 服务器今天开始时间戳(秒/毫秒)，如：2021-01-01 00:00:00的秒级/毫秒级时间戳
            /// 如果是秒级，返回秒级时间戳，如果是毫秒级，返回毫秒级时间戳
            /// </summary>
            /// <returns></returns>
            ...
            /// 获取当前Utc时间
            /// </summary>
            /// <param name="useAntiCheating">是否使用时间防作弊方案</param>
            /// <returns></returns>
            public static DateTime GetUtcNow(bool useAntiCheating = true)
            {
                return useAntiCheating ? TimeAntiCheating.GetUtcNow() : DateTime.UtcNow;
            }
            ...
            public static int NowUtcDate() => Convert.ToInt32(GetUtcNow().ToString("yyyyMMdd"));
            ...
            public static string NowUtcTimeStr() => GetUtcNow().ToString("HHmmss");
            ...
            public static string NowUtcDateTimeStr() => GetUtcNow().ToString("yyyy-MM-dd-HH-mm-ss.fff K");
            ...
            /// <param name="hour">小时。</param>
            /// <returns>跨越的天数。</returns>
            public static int GetCrossDaysToNowUtc(DateTime startTime, int hour = 0) => GetCrossDays(startTime, GetUtcNow(), hour);
            ...
            public static bool IsSameDayByUtc(long timestamp1, long timestamp2)
            {
            ...
            /// <param name="timestamp2">时间戳2</param>
            /// <returns>是否是同一天</returns>
            public static bool IsSameDayByLocal(long timestamp1, long timestamp2)
            {
            ...
            public static DateTime GetTodayStartTime() => GetUtcNow().Date;
            ...
            public static DateTime GetTodayEndTime() => GetUtcNow().Date.AddDays(1).AddSeconds(-1);
            ...
            public static DateTime GetTomorrowStartTime() => GetUtcNow().Date.AddDays(1);
            ...
            public static DateTime GetTomorrowEndTime() => GetUtcNow().Date.AddDays(2).AddSeconds(-1);
            ...
            public static bool IsSameWeek(long targetTime) => IsSameWeek(new DateTime(targetTime));
            ...
            /// <returns>如果当前时间与指定时间处于同一周，则为 true；否则为 false。</returns>
            public static bool IsSameWeek(DateTime targetDate) => IsSameWeek(targetDate, DateTime.Now);
