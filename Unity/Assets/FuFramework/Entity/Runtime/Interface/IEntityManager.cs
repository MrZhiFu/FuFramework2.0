...
//     /// <summary>
//     /// 实体管理器接口。
//     /// 功能：定义实体管理器的相关接口。包括实体的创建、销毁、显示、隐藏等。
//     /// </summary>
...
//         void SetEntityHelper(DefaultEntityHelper entityHelper);
//
//         /// <summary>
//         /// 是否存在实体组。
//         /// </summary>
...
//         bool AddEntityGroup(string entityGroupName, float instanceAutoReleaseInterval, int instanceCapacity, float instanceExpireTime, int instancePriority, EntityGroupHelper entityGroupHelper);
//
//         /// <summary>
//         /// 是否存在实体。
//         /// </summary>
