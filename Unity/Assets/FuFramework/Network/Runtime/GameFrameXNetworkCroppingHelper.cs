...
namespace FuFramework.Network.Runtime
{
    public class GameFrameXNetworkCroppingHelper : MonoBehaviour
    {
        private void Start()
        {
            _ = typeof(EAddressFamily);
            _ = typeof(BasePacketHeartBeatHandler);
            _ = typeof(DefaultMessageCompressHandler);
            _ = typeof(DefaultMessageDecompressHandler);
            ...
            _ = typeof(GameFrameXNetworkCroppingHelper);
            _ = typeof(IHeartBeatMessage);
            _ = typeof(IMessageCompressHandler);
            _ = typeof(IMessageDecompressHandler);
            ...
            _ = typeof(MessageHandlerAttribute);
            _ = typeof(MessageHttpObject);
            ...
            _ = typeof(NetworkManager.RpcState);
            _ = typeof(NetworkManager.RpcState.RpcMessageData);
            _ = typeof(NetworkManager.SendState);
            _ = typeof(NetworkMissHeartBeatEventArgs);
            _ = typeof(ProtoMessageHandler);
            _ = typeof(ProtoMessageIdHandler);
            _ = typeof(EServiceType);
        }
    }
}