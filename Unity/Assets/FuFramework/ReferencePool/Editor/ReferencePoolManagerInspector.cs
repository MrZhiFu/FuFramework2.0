...
namespace FuFramework.ReferencePool.Editor
{
    ...
    internal sealed class ReferencePoolManagerInspector : FuFrameworkInspector
    {
        /// <summary>
        ...
        public override void OnInspectorGUI()
        {
            ...
            var poolManager = target as ReferencePoolManager;
            if (poolManager == null) return;

            if (!EditorApplication.isPlaying) return;
            
            var enableStrictCheck = EditorGUILayout.Toggle("激活严格检查(打开可能会影响性能)", ReferencePoolManager.EnableStrictCheck);
            if (enableStrictCheck != ReferencePoolManager.EnableStrictCheck)
                ReferencePoolManager.EnableStrictCheck = enableStrictCheck;
            ...
            var referencePoolInfos = ReferencePool.Runtime.ReferencePool.GetAllReferencePoolInfos();
