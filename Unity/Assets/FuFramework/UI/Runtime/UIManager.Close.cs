...
namespace FuFramework.UI.Runtime
{
    ...
    public sealed partial class UIManager
    {
        ...
        public void CloseUI(int serialId)
        {
            ...
            if (view == null)
            {
                FuLog.Error($"[UIManager]需要关闭的UI界面View为空 '{serialId}'.");
                return;
            }
        ...
        public void CloseUI(ViewBase view)
        {
            if (view == null)
            {
                FuLog.Error("[UIManager]需要关闭的UI界面为空");
                return;
            }

            if (view.UIGroup == null)
            {
                FuLog.Error("[UIManager]需要关闭的UI界面组为空");
                return;
            }
            ...
            m_EventManager.Broadcast(this, closeUICompleteEventArgs);
        ...
        public void CloseUINow(int serialId)
        {
            ...
            if (view == null)
            {
                FuLog.Error($"[UIManager]找不到界面 '{serialId}'");
                return;
            }
        ...
        public void CloseUINow(ViewBase view)
        {
            if (view == null)
            {
                FuLog.Error("[UIManager]需要关闭的UI界面View为空");
                return;
            }
