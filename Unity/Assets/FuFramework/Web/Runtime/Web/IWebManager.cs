...
namespace FuFramework.Web.Runtime
{
    ...
    public interface IWebManager
    {
        ...
        /// </remarks>
        Task<T> Post<T>(string url, FuFramework.Network.Runtime.MessageObject message) where T : FuFramework.Network.Runtime.MessageObject, FuFramework.Network.Runtime.IResponseMessage;
