...
namespace Unity.Startup.Procedure
{
    ...
    /// 3. 进入更新资源清单流程
    /// </summary>
    public class ProcedureUpdateGetPackageVersion : ProcedureBase
    {
        protected override async void OnEnter(IFsm<IProcedureManager> procedureOwner)
        {
            base.OnEnter(procedureOwner);
            Log.Info("<color=#43f656>------进入热更流程--获取资源包版本流程-----</color>");
            ...
            await GetVersion(procedureOwner).ToUniTask();
        }
        ...
        private IEnumerator GetVersion(IFsm<IProcedureManager> procedureOwner)
        {
            ...
            if (operation.Status == EOperationStatus.Succeed)
            {
                ...
                // 进入更新资源清单流程
                Log.Info($"获取资源版本成功 : {operation.PackageVersion}");
