...
namespace Unity.Startup.Procedure
{
    ...
    /// </summary>
    public class ProcedureGetAppVersionInfo : ProcedureBase
    {
        protected override void OnEnter(IFsm<IProcedureManager> procedureOwner)
        {
            ...
            {
                Log.Info("当前为编辑器模式，直接启动 FsmGetAppVersionInfoState");
        ...
        private async void GetAppVersionInfo(IFsm<IProcedureManager> procedureOwner)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        var uiLauncher = GameApp.UI.GetLoaded<UILauncher>();
                        ...
                        uiLauncher.m_upgrade.m_EnterButton.onClick.Set(() =>
                        {
                            ...
                            else
                            {
                                ...
                                ChangeState<ProcedureGetAssetVersionInfo>(procedureOwner);
                            }
                        });
                    }
                    else
