...
namespace Hotfix.Game.Tables.Tables
{
    ...
    /// 引导步骤表
    /// </summary>
    public partial class TbGuideStep : BaseDataTable<Tables.GuideStep>
    {
        private readonly System.Func<System.Threading.Tasks.Task<JSONNode>> _loadFunc;        
        public TbGuideStep(System.Func<System.Threading.Tasks.Task<JSONNode>> loadFunc)
        {
            _loadFunc = loadFunc;
        }
        public override async System.Threading.Tasks.Task LoadAsync()
        {
            ...
            {
                Tables.GuideStep _v;
                { if(!_ele.IsObject) { throw new SerializationException(); }  _v = global::Hotfix.Game.Tables.Tables.GuideStep.DeserializeGuideStep(_ele);  }
                DataList.Add(_v);
