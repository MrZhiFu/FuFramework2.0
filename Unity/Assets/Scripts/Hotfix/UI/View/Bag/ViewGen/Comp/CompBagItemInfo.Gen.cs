...
namespace Hotfix.UI
{
    public partial class CompBagItemInfo : GComponent, ICustomComp
    {
		...
		private CompGoodItem compBagItem;
		private GButton btnUse;
        ...
        public void InitUIComp()
        {
			...
			compBagItem = (CompGoodItem)GetChild("_compBagItem");
        ...
        {
	        uiView?.StartTimer(interval, intervalCallback, repeatCount, immediate, ignoreTimeScale);
        }
        ...
        {
	        uiView?.StartTimer(frameInterval, intervalCallback, repeatCount, immediate, playerLoopTiming);
        }
